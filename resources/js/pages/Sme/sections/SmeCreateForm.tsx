...
const STEPS = [
  ...
  { id: 3, name: 'Additional Members', description: 'Optional team members' },
...
export const SmeCreateForm = forwardRef<any, SmeCreateFormProps>(({
  ...
  const validateStep1 = () => {
    ...
    if (!businessData.contactPhone) newErrors.contactPhone = 'Contact Phone is required';
  ...
  const validateStep2 = () => {
    ...
    if (!primaryOwner.nationalIdNumber) newErrors.nationalIdNumber = 'National ID is required';
    ...
    if (!primaryOwner.phoneNumber) newErrors.phoneNumber = 'Phone Number is required';
    setErrors(newErrors);
    return Object.keys(newErrors).length === 0;
  };
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setPrimaryOwner({ ...primaryOwner, nationalIdNumber: e.target.value })}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setPrimaryOwner({ ...primaryOwner, phoneNumber: e.target.value })}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setPrimaryOwner({ ...primaryOwner, landlineNumber: e.target.value })}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setPrimaryOwner({ ...primaryOwner, altContactPhone: e.target.value })}
                      placeholder="Enter phone"
                    />
                  </div>
                </div>
