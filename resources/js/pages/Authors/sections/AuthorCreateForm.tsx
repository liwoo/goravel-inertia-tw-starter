...
import { AuthorCreateData, AuthorStatus } from '@/types/author';
import { Separator } from '@/components/ui/separator';
import { NATIONALITIES } from '@/config/options';

interface AuthorCreateFormProps extends CrudFormProps {
  setIsSaving?: (saving: boolean) => void;
}

export const AuthorCreateForm = forwardRef<any, AuthorCreateFormProps>(
  ({ onSuccess, onError, onCancel, isLoading = false, setIsSaving }, ref) => {
    const { t } = useTranslation('authors');
    const [formData, setFormData] = useState<AuthorCreateData>({
      firstName: '',
      lastName: '',
      bio: '',
      email: '',
...
AuthorCreateForm.displayName = 'AuthorCreateForm';
