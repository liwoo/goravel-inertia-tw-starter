...
type BusinessEmployeeSummary struct {
	...
	FullTimeWithContractMales  int     `json:"full_time_with_contract_males" db:"full_time_with_contract_males"`
	FullTimeWithContractFemales int    `json:"full_time_with_contract_females" db:"full_time_with_contract_females"`
	TemporaryMales             int     `json:"temporary_males" db:"temporary_males"`
	TemporaryFemales           int     `json:"temporary_females" db:"temporary_females"`
