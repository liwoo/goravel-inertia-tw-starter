...
type M20251119090154AddAuditFieldsToBdspsTable struct {
}

// Signature The unique signature for the migration.
func (r *M20251119090154AddAuditFieldsToBdspsTable) Signature() string {
	return "20251119090154_add_audit_fields_to_bdsps_table"
}

// Up Run the migrations.
func (r *M20251119090154AddAuditFieldsToBdspsTable) Up() error {
...
func (r *M20251119090154AddAuditFieldsToBdspsTable) Down() error {
	return facades.Schema().Table("bdsps", func(table schema.Blueprint) {
